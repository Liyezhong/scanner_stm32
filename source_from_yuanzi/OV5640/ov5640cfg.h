...
const u16 OV5640_jpeg_reg_tbl[][2]=
{
	...
	0x501f, 0x00, // YUV 422
	// Input clock = 24Mhz
	0x3035, 0x21,//0x71,//0x21, // PLL  
	0x3036, 0x69, // PLL 
	0x3c07, 0x07, // lightmeter 1 threshold[7:0] 
	0x3820, 0x40, // no flip	0x3820, 0x46, // flip
	0x3821, 0x26, // no mirror			0x3821, 0x20, // mirror			
	...
	0x3802, 0x00, // VS 
	0x3803, 0x00, // VS 
	0x3804, 0x0a, // HW (HE)		2043 2623  1463
	0x3805, 0x3f, // HW (HE)
	0x3806, 0x07, // VH (VE)		 
	0x3807, 0x9f, // VH (VE) 		1951
	
	0x3808, 0x02, // DVPHO 	   different
	0x3809, 0x80, // DVPHO     different
	0x380a, 0x01, // DVPVO 		 different
	0x380b, 0xe0, // DVPVO     different
	...
	0x3824, 0x02,//0x02, // PCLK manual divider .01 03 04 08 neither work .
  0x5001, 0xA3, // SDE on, Scaling on, CMX on, AWB on       different
	0x3503, 0x00, // AEC/AGC on	
};

const u16 OV5640_jpeg_reg_change[][2]=
{
	...
	0x460c, 0x22,
	0x4837, 0x16, // MIPI global timing 
	0x3824, 0x01, // PCLK manual divider .01 03 04 08 neither work .
  0x5001, 0xA3, // SDE on, Scaling on, CMX on, AWB on       different
	0x3503, 0x00, // AEC/AGC on	
...
//	0x3503, 0x00, // AEC/AGC on	
	...
	0x4837, 0x16, // MIPI global timing
	0x3824, 0x04, // PCLK manual divider
	0x5001, 0xA7, // SDE on, scale on, UV average off, color matrix on, AWB on
	0x3503, 0x00, // AEC/AGC on
}; 
