...
//		LTDC_Init();			    //ID非零,说明有RGB屏接入.
	...
	LCD_Display_Dir(0);		//默认为竖屏 //xuru disp
...
void LCD_C5_TEST(uint8_t data1,uint8_t data2)
{
	static uint8_t data = 0;
  LCD_WR_REG(0xC5);    //VCM control 
  LCD_WR_DATA(data1); 	 //3C
  LCD_WR_DATA(data2); 	 //3F	
	printf("current C5 value.data1:%d.data2:%d.\n",data1,data2);
	
//	LCD_WR_REG(0xC7);    //VCM control 
//	LCD_WR_DATA(0x80 & data);
//	printf("current C7 value: %d.\n",data);	
